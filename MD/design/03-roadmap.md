...
詳細子階段見 [`MD/design/06-arm7tdmi-completion-plan.md`](/MD/design/06-arm7tdmi-completion-plan.md)。
...
詳見 [`MD/design/08-portability-refactor.md`](/MD/design/08-portability-refactor.md)。
...
詳見 [`MD/design/09-gb-lr35902-validation-plan.md`](/MD/design/09-gb-lr35902-validation-plan.md)。
...
紀錄參見 [`MD/note/framework-emitter-architecture.md`](/MD/note/framework-emitter-architecture.md) 跟
[`MD/note/performance-baseline-2026-05.md`](/MD/note/performance-baseline-2026-05.md)。

---

## Phase 5：Memory Bus + BIOS LLE + PPU 完整化 ✅ 完成 (2026-05-02)

> **完工筆記**：[`MD/note/phase5-gba-mvp-complete-2026-05.md`](/MD/note/phase5-gba-mvp-complete-2026-05.md) (5.1–5.4)
> + [`MD/note/phase5.7-bios-lle-and-ppu-2026-05.md`](/MD/note/phase5.7-bios-lle-and-ppu-2026-05.md) (5.5–5.7)。
>
...
[`MD/note/loop100-bench-2026-05-phase5.8.md`](/MD/note/loop100-bench-2026-05-phase5.8.md)。**結論：refactor 對主
...
JIT）見 [`MD/note/loop100-bench-2026-05.md`](/MD/note/loop100-bench-2026-05.md)**。1200 frames stress-test
...
([`MD/note/performance-baseline-2026-05.md`](/MD/note/performance-baseline-2026-05.md)) 已 superseded — 跑法
不統一、ROM 不同，僅作歷史紀錄。
...
canonical loop100 bench ([`MD/performance/202605030002-jit-optimisation-starting-point.md`](/MD/performance/202605030002-jit-optimisation-starting-point.md))
記錄 before/after。
...
GB block-JIT 從無到有，子題 roadmap 在 [`MD/design/12-gb-block-jit-roadmap.md`](/MD/design/12-gb-block-jit-roadmap.md)。
P0 4 步 + P0.5/P0.6/P0.7/P0.7b 後續、P1 #5/#5b/#6/#7 主體都已 ship。

**P0 4 步**（[`MD/performance/202605040000-gb-block-jit-p0-complete.md`](/MD/performance/202605040000-gb-block-jit-p0-complete.md) 詳載）：
...
**P1 主體**（[`MD/design/12-gb-block-jit-roadmap.md`](/MD/design/12-gb-block-jit-roadmap.md) §3 Tier P1）：
...
**剩餘 P2/P3/P4**：詳見 [`MD/design/12-gb-block-jit-roadmap.md`](/MD/design/12-gb-block-jit-roadmap.md) §3。下一步建議
...
[`MD/performance/202605032030-bios-loop100-bench.md`](/MD/performance/202605032030-bios-loop100-bench.md)。Detector 把 unconditional
...
- **C.b alloca-based shadow lazy flag** — 兩次 retry 都失敗：第一次 (2026-05-03
  ...
  [`MD/performance/202605031930-Cb-lazy-flag-deferred.md`](/MD/performance/202605031930-Cb-lazy-flag-deferred.md)。
...
- [x] **A.5 SMC 偵測 + invalidation**（2026-05-04 完成，V1+V2）— V1
  ...
  + 精確 per-instr coverage (always-on)。詳見 [`MD/design/12-gb-block-jit-roadmap.md`](/MD/design/12-gb-block-jit-roadmap.md)
...
- [x] **A.8 State→register caching**（2026-05-04 完成 V1，與 P1 #5
  ...
  節省)；V2 per-block live-range 待做。詳見 [`MD/design/12-gb-block-jit-roadmap.md`](/MD/design/12-gb-block-jit-roadmap.md)
  P1 #5。
...
- [x] **OptLevel 調 O3** ~~+ 加入額外 LLVM passes (instcombine, gvn,
  ...
  (±3%, see [`MD/performance/202605030025-optlevel-0-to-3.md`](/MD/performance/202605030025-optlevel-0-to-3.md))。原因：
...
- [x] **B.e Cache state-buffer offsets in CpuExecutor**（2026-05-03，perf
  note [`MD/performance/202605030054-cache-state-offsets-cpuexecutor.md`](/MD/performance/202605030054-cache-state-offsets-cpuexecutor.md)）
...
- [x] **B.f Permanent pin of state buffer**（2026-05-03，perf note
  [`MD/performance/202605030102-permanent-pin-state-buffer.md`](/MD/performance/202605030102-permanent-pin-state-buffer.md)）— 把
...
- [x] **B.g AggressiveInlining for GBA bus methods**（2026-05-03，perf
  note [`MD/performance/202605030108-aggressive-inlining-bus-methods.md`](/MD/performance/202605030108-aggressive-inlining-bus-methods.md)）
...
- [x] **B.h Scheduler.Tick + DeliverIrqIfPending AggressiveInlining**
  （2026-05-03，perf note [`MD/performance/202605030209-scheduler-irq-inline.md`](/MD/performance/202605030209-scheduler-irq-inline.md)）
...
- [x] **C.a Width-correct status flag access**（2026-05-03，perf note
  [`MD/performance/202605030135-width-correct-flag-access.md`](/MD/performance/202605030135-width-correct-flag-access.md)）— CpsrHelpers
...
- [⏸ deferred — 2026-05-03 retry 失敗] **C.b Alloca-based shadow lazy flag**
  ...
  **defer 原因**：
  ...
  詳見 [`MD/performance/202605031930-Cb-lazy-flag-deferred.md`](/MD/performance/202605031930-Cb-lazy-flag-deferred.md)。**何時重評**：
...
- [x] **E.a Instruction-fetch fast path** (CpuExecutor side)（2026-05-03,
  perf note [`MD/performance/202605030120-instruction-fetch-fast-path.md`](/MD/performance/202605030120-instruction-fetch-fast-path.md)）
...
- [x] **E.b JIT-side data load/store fast path** (extern trampoline side)
  （2026-05-03，perf note [`MD/performance/202605030125-jit-mem-trampoline-fast-path.md`](/MD/performance/202605030125-jit-mem-trampoline-fast-path.md)）
...
- [x] **F.x InstructionDef-keyed fn pointer cache**（2026-05-03，commit
  `caf939b` + perf note [`MD/performance/202605030036-fnptr-cache-by-instruction-def.md`](/MD/performance/202605030036-fnptr-cache-by-instruction-def.md)）
...
- [x] **F.y Pre-built DecodedInstruction cache**（2026-05-03，perf
  note [`MD/performance/202605030047-prebuilt-decoded-instruction.md`](/MD/performance/202605030047-prebuilt-decoded-instruction.md)）
...
- [x] **H.a LLVM pass pipeline 調校**（2026-05-03，perf notes
  [`MD/performance/202605031900-Ha-llvm-pass-pipeline-reenabled.md`](/MD/performance/202605031900-Ha-llvm-pass-pipeline-reenabled.md) +
  [`MD/performance/202605031940-Ha-instcombine-fix.md`](/MD/performance/202605031940-Ha-instcombine-fix.md)）— HostRuntime.Compile
...
[`MD/performance/202605030002-jit-optimisation-starting-point.md`](/MD/performance/202605030002-jit-optimisation-starting-point.md)，
記錄 before/after delta + 該策略 hypothesis。**不要批一次做完幾項
混在一起跑**，會搞不清楚哪個帶來收益。

**Commit 前 QA**：依改動性質跑對應 tier，定義在
[`MD/process/01-commit-qa-workflow.md`](/MD/process/01-commit-qa-workflow.md)：
- T0 = 純文件 / 註解 → 無 QA
...
> 細節見 [`MD/note/phase5.7-bios-lle-and-ppu-2026-05.md`](/MD/note/phase5.7-bios-lle-and-ppu-2026-05.md) 第 5 節。
>
...
| **28.8** | FreeDOS 1.3 boot attempt（高度不確定）| `A:\>` prompt 截圖 | 🚧 28.8a (0xEA) + 28.8b (INT 8/9) + 28.8c (RETF/CALLF/全 IVT defaults) ✅ → FreeDOS kernel banner "FreeDOS kernel 2043 (build 2043 OEM:0xfd) [c" 印出 ✓ |
