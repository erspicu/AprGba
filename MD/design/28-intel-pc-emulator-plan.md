...
| 28.8b | FreeDOS boot blocker #2 — install HLE INT 8/9 defaults; IRQ 0 → IVT[8]=0:0 wandering | ✅ | (this commit) | 2026-05-15 |
| 28.8c | FreeDOS boot blocker #3 — kernel code halts at 0060:0033 | ⏳ pending | — | — |
