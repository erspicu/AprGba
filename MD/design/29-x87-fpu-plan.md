...
| 29.3d | FLD m32fp + FXCH ST(i) + FLD1/FLDPI/... | Phase 29.3 finish: memory load with f32→f64 conversion (FLD m32fp D9 /0 mem), register-form stack swap (FXCH ST(i) D9 C8+i), constant pushes (FLD1, FLDL2T, FLDL2E, FLDPI, FLDLG2, FLDLN2 — D9 E8..ED). |
