...
| 30.8 | Force pcxtbios MDA mode 7 path — make CGA CRTC probe fail when `--video=mda` so BIOS settles on MDA. Likely requires returning specific failure pattern at port 0x3D4/0x3D5 or hooking INT 10h init. | ⏳ deferred |
