...
- `spec/cpu/x86-16/i8086/cpu.json`：3000+ 行 spec，6 個 group files。
...
寫個 Python 腳本：
1. 掃描 `spec/cpu/x86-16/i8086/groups/*.json` 每個 instruction
...
**Files**: `spec/cpu/x86-16/i80186/groups/i80186-additions.json` (~150 lines)
...
**Files**: `spec/cpu/x86-16/i80186/groups/i80186-overrides.json` (~30 lines for the two silicon quirks)
...
- **A**: Convention — `spec/<family>/<lowercase-id>/cpu.json`（i80186 → `spec/cpu/x86-16/i80186/cpu.json`）
