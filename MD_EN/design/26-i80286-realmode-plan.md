...
- spec/cpu/x86-16/i8086/cpu.json — base spec, 149 instructions with stable IDs.
- spec/cpu/x86-16/i80186/cpu.json — extends i8086, +26 instructions, 1 silicon override.
