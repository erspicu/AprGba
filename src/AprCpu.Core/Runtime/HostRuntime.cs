...
public sealed unsafe class HostRuntime : IDisposable
{
    ...
    public void Compile()
    {
        ...
        // Phase 7 H.a — explicit IR-level optimization pipeline. ORC
        // LLJIT runs only the codegen passes by default; mem2reg / GVN /
        // DSE / instcombine / simplifycfg must be invoked explicitly so
        // our alloca-shadow patterns (C.b lazy flag, B.f permanent pin)
        // get lifted to SSA and benefit from CSE.
